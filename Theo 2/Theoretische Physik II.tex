...
\begin{itemize}
  ...
  \item Ortsdarstellung der EZ $|lm\rangle$: Kugelflächenfunktion
   ...
   \end{align}
\end{itemize}
\textbf{Elegantere Variante: Lieteroperatoren}\\
1. Abbruchbedingung
  \begin{align}
  \hat{L}_+|ll\rangle=0
  \end{align}
  ...
  \begin{itemize}
    ...
    \item Hilbertraum: Betrachte ein Elektron
      ...
      \end{align}
      $\hookrightarrow$ Tensorprodukt: Kombinieren Freiheitsgrade aus verschiedenen Hilberträumen
    \item Dimensionen
      \begin{align}
    ...
    \item Zustand in $\mathbb{H}_e$
      \begin{align}
      \underbrace{|\alpha\rangle}_{\in \ \mathbb{H}_e}=\underbrace{|\psi\rangle}_{\in\ \mathbb{H}_\text{Ort}}\otimes \underbrace{|X\rangle}_{\in\ \mathbb{H}_\text{Spin}}
      \end{align}
