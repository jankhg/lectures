...
\label{eq:Hamiltonoperater Ortsdarstellung}
\end{equation}
...
&=\rangle E_n\left.\right|\hat{A}\left.\right|E_n\rangle
\end{align}
...
\end{equation}
resultiert aus Zeitabh- der Zustände, Operatoren sind zeitabhängig
...
\end{align}
unitäre Transformation des Operators\\
