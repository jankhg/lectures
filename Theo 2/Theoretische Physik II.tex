...
\begin{itemize}
  \item Gegeben sei Operator $\hat{A}$. Ket-Vektoren $\left.\right|a>$ heiße Eigenvektor zum Eigenwert a. \textcolor[rgb]{1,0,0}{Wenn}
    \begin{equation}
...
\begin{itemize}
  ...
  \item Vollständigkeit: Entwicklung eines beliebigen Vektors $\left.\right|\beta>$ in Eigenbasis $\left.\right|a_i>$:
    ...
    - Multiplikation $<a_j\left.\right|$
      ...
      &\textcolor[rgb]{1,0,0}{=\sum_i C_i>a_j\left.\right|a_i>}\\
      &=\sum_iC_i \Delta_{ij}\\
      &=C_j
      \end{aligned}
      \end{equation}
