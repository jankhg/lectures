...
\subsection{Kontrolle thermodynamischer Gleichgewichtszustände}
 ...
 \textbf{Postulat III:}\\
Der neue adiabatisch erreichbare, thermodynamische Gleichgewichtszustand ist durch maximale Entropie charakterisiert, d.h.\\ $S(X_0) \quad \rightarrow$  max.,\\ 
falls $X_0$ eindeutig, dann $X_0$ stabil\\
 \textbf{Thermodynamische Fundamentalrelation}
\begin{fleqn}
\begin{equation}
 \quad S(X) \xrightarrow{X=(U,V,N)} dS(U,V,N)= \underbrace{\left.\frac{\partial S}{\partial U}\right|_{(V,N)}}_{=:\frac{1}{T}} dU  + \underbrace{\left.\frac{\partial S}{\partial V}\right|_{(U,N)}}_{=:\frac{p}{T}} + \underbrace{\left.\frac{\partial S}{\partial N}\right|_{(U,V)}}_{=:-\frac{\mu}{T}} dN \stackrel{!}{=}0
\end{equation}
\end{fleqn}
mit\\
$T$: Temperatur\\
